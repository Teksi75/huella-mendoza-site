            ...
            <div className="max-w-xl">
              ...
              <div className="mb-6">
                <p className="text-base leading-relaxed text-gray-700 text-center md:text-left">
                  Base es el módulo estructural del sistema HUELLA.
                  <br />
          ...
          <div className="max-w-3xl">
            ...
            <div className="mb-6">
              <p className="text-base leading-relaxed text-gray-700">
                ...
                optimicen.
                <br />
                Definir la cantidad de módulos base desde el principio permite planificar
                logística y obra de forma ordenada y clara.
              </p>
            </div>
          </div>
            ...
            <div className="max-w-xl">
              <div className="mb-6">
                ...
                <p className="mt-3 text-base leading-relaxed text-gray-700">
                  ...
                  configuraciones para diferentes usos y pensar un conjunto de módulos como un
                  sistema mayor que se adapta con el tiempo.
                </p>
                <p className="mt-3 text-base leading-relaxed text-gray-700">
                  Este enfoque por cantidad de módulos organiza mejor la logística y la obra
                  desde el inicio, facilita cotizaciones claras y permite proyectar espacios que
                  crecen sin perder coherencia.
                </p>
                <p className="mt-3 text-base leading-relaxed text-gray-700">
              ...
              <div className="mb-6">
                <p className="text-base leading-relaxed text-gray-700">
                  Analizamos tu idea y la cantidad de módulos.
                </p>
                <p className="mt-3 text-base leading-relaxed text-gray-700">
