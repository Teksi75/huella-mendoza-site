            ...
            <div className="max-w-xl">
              ...
              <div className="mb-6">
                <p className="text-base leading-relaxed text-gray-700 text-center md:text-left">
                  <span className="block">Base es el módulo estructural del sistema HUELLA.</span>
                  <span className="block">
                    Cada proyecto se define a partir de una cantidad de módulos base que
                    funcionan como la pieza fundamental para organizar costos, tiempos y
                    posibilidades futuras.
                  </span>
                  <span className="block">
                    Esto permite planificar con claridad, reducir incertidumbres y pensar
                    espacios que crecen sin improvisaciones.
                  </span>
                </p>
              </div>
            </div>
          ...
          <div className="max-w-3xl">
            ...
            <div className="mb-6">
              <p className="text-base leading-relaxed text-gray-700">
                La lógica modular hace que las unidades encajen entre sí y en el transporte,
                la obra en sitio se coordine con menos imprevistos y los tiempos de montaje se
          ...
          <div className="mt-10 max-w-3xl">
            <div className="mb-6">
              ...
              <p className="mt-3 text-base leading-relaxed text-gray-700">
                Pensamos los materiales y aislamientos para acompañar el clima y el entorno,
                tanto en una unidad como en varias combinadas.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            ...
            <div className="max-w-xl">
              <div className="mb-6">
                ...
                <p className="mt-3 text-base leading-relaxed text-gray-700">
                  Podés empezar con una sola unidad, sumar módulos base, combinar
                  configuraciones para diferentes usos y pensar un conjunto de módulos como
                  un sistema mayor que se adapta con el tiempo.
                </p>
                <p className="mt-3 text-base leading-relaxed text-gray-700">
                  Este enfoque por cantidad de módulos organiza mejor la logística y la obra
                  desde el inicio, facilita cotizaciones claras y permite proyectar espacios
                  que crecen sin perder coherencia.
                </p>
                <p className="mt-3 text-base leading-relaxed text-gray-700">
