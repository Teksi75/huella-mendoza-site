...
const HomeLandscapeBreak = () => (
  <section className="section-padding bg-tierra-100">
    <div className="container-custom">
      <div className="relative aspect-[16/9] overflow-hidden rounded-2xl border border-tierra-200 bg-white shadow-sm">
        <Image
