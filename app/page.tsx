      ...
      >
        <div className="container-custom">
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-3">
            <div className="flex flex-col rounded-2xl border border-tierra-200 bg-white p-8 shadow-sm transition-all duration-300 ease-out hover:shadow-md">
              <div className="min-h-[200px]">
                <div className="flex items-center gap-3">
                  <Layers
                    className="h-5 w-5 text-tierra-600"
                    strokeWidth={1.5}
                    aria-hidden
                  />
            ...
            <div className="flex flex-col rounded-2xl border border-tierra-200 bg-white p-9 shadow-md ring-1 ring-tierra-900/5 transition-all duration-300 ease-out hover:-translate-y-0.5 hover:shadow-lg">
              <div className="min-h-[200px]">
                <div className="flex items-center gap-2">
                  <Compass
                    className="h-[22px] w-[22px] text-tierra-700"
                    strokeWidth={1.5}
                    aria-hidden
                  />
              ...
              <Link
                href="/diseno"
                className="btn-primary mt-6 inline-flex w-full items-center justify-center text-sm shadow-md shadow-tierra-900/15 transition-all duration-300 ease-out hover:shadow-lg"
              >
                Explorar Diseño
              </Link>
            </div>
            <div className="flex flex-col rounded-2xl border border-tierra-200 bg-white p-8 shadow-sm transition-all duration-300 ease-out hover:shadow-md">
              <div className="min-h-[200px]">
                <div className="flex items-center gap-3">
                  <Leaf className="h-5 w-5 text-tierra-600" strokeWidth={1.5} aria-hidden />
