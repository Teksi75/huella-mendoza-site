...
export default function ImageCarouselModal({
  ...
  const activeSubtitle = activeImage?.subtitle ?? subtitle;
  ...
  useEffect(() => {
    ...
    if (carouselRef.current) {
      ...
      if (initialIndex > 0) {
        const slide = carouselRef.current.children[
          initialIndex
        ] as HTMLElement | undefined;
        slide?.scrollIntoView({ behavior: 'auto', inline: 'start' });
      }
    }
  }, [initialIndex, isOpen]);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby={activeTitle ? titleId : undefined}
        aria-describedby={activeSubtitle ? subtitleId : undefined}
