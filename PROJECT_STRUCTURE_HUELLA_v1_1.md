...
- CTA flotante de WhatsApp: definido en `app/layout.tsx` (posición fixed). Si cambia el número o el mensaje prearmado, revisar también `data/contact.ts`.
...
- Assets “Oficina” (uso posible): `public/media/huella/diseno/usos/Oficina_concept_1.png` y `Oficina_concept_2.png`.
